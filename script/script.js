                        ...
                        `</td>
                            <td>
                                <div class="float-center">
                                    <button type="button" id="update-book-info-button-` + i + `"class="btn btn-primary badge-pill" style="width: 80px;">Update</button>
...
$(document).ready(function () {
    $(".btn btn-primary badge-pill").on("click", function () {
        var id = $(this).attr('id');
        alert(id);
